...
public class Evento {
    ...
    /**
     * Costruttore vuoto che si occupa di instanziare l'evento
     */
    public Evento() {
    }
     ...
     * @param descrizione rappresenta la nuova descrizione di ciò che verrà fatto durante l'evento
     */
     ...
     * @param altreInformazioni rappresenta le nuove altre informazioni utili per l'evento
     */
