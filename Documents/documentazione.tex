...
\usepackage{hyperref}
\usepackage{graphicx}       %usato per collegamenti ipertestuali
        ...
        \chapter{Cos'è WeatherStyle?}
            ...
            \subsection{Caratteristiche dell'ambiente}
                \begin{itemize}
                    ...
                    completo dell'ambiente in ogni momento, ossia ha visione completa dei capi presenti nel guardaroba
                    ...
                    stato corrente e dall'azione eseguita dall'agente, quindi è un ambiente che non cambia nel tempo.
