...
\begin{document}
    ...
    \section{Evaluation}
            ...
            impostare il numero minimo di istanze per foglia a 10, ciò è possibile utilizzando il metodo \emph{setMinNum}.
            \par \noindent E infine per ridurre ancora di più la size dell'albero come discusso nella sezione 3.5 abbiamo utilizzato il
    ...
    \part{Conclusioni e osservazioni}
        \chapter{Cosa scegliamo?}
            \section{Un confronto tra Algoritmi Genetici e Machine Learning}
                ...
                sulla carta più efficiente a livello computazionale dell'algoritmo genetico.
                \par \noindent Quindi non c'è una vera e propria scelta su quale soluzione sia migliore, sono entrambe
                ampiamente funzionali e in linea agli obbiettivi iniziali.
            \section{Possiamo fare di meglio}
                ...
                Il problema principale riscontrato nella realizzazione del modello di Machine Learning è stata quella di avere
                ...
                effettuando costruzione dell'albero tramite un algoritmo genetico.
