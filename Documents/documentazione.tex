    ...
    \part{Tecniche di risoluzione}
        ...
        compito del progettista è cercare di migliorare la capacità di esplorazione dell'algoritmo.
            ...
            \textbf{Jenetics} \cite{1}.
                ...
                scelto gli operatori genetici è giunta loro di fare il setup dell'algoritmo.
                ...
                \begin{algorithmic}[1]
                    ...
                    \State
                    \State $geneticAlgorithm \gets (populationSize, genotype, fitness, constraint, selector, crossover, mutator)$
                \end{algorithmic}
