...
\begin{document}
    ...
    \chapter{Il machine learning}
        ...
        di predire il valore di una variabile numerica sulla base degli input forniti.
            ...
            formato e alla loro qualità.
                ...
                Per fortuna, su kakkle\cite{3} è disponibile il dataset\cite{7} che ci ha permesso di andare avanti con il nostro lavoro.
                \\
                ...
                \begin{itemize}
                    ...
                    Questo oltre a servirci poco, può essere considerato un attributo sensibile e,
                ...
                Il sito Open-meteo\cite{8} permette di scaricare dati storici delle previsioni meteorologiche.
                ...
                Si è deciso di optare, quindi, per i dati giornalieri utilizzando le seguenti caratteristiche:
                \begin{itemize}
                    \item \emph{WeatherCode} : codice che indica il meteo previsto (Eg. Piovoso, Soleggiato);
    ...
    \begin{itemize}
        ...
        in questo caso si è optato per uno dei più semplici: eliminazioni di righe contenenti valori nulli.
        ...
        logicamente sfruttando rispettivamente le colonne \emph{Insole} e \emph{}
    \end{itemize}
