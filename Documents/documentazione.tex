    ...
    \part{Introduzione}
        \chapter{Cos'è WeatherStyle?}
            ...
            \begin{itemize}
                ...
                \\ I sensori a sua disposizione sono una sorgente da cui ottenere informazioni meteorologiche\footnote{Nel driver sviluppato per testare il modello, tale sensore è sostituito dalla tastiera,
                    è l'utente che deve specificare le condizioni meteo e la data in cui il consiglio viene fornito}
                    e un database da cui ottenere i capi d'abbigliamento dell'utente\footnote{Il driver realizzato non fa uso del database.
                Viene utilizzato un File per caricare dei capi d'esempio su cui poter effettuare dei test.
                Inoltre, è possibile aggiungere altri capi che saranno salvati nella sessione del browser utilizzato per il testing (Una volta chiuso dovranno essere ricaricati).}.
            \end{itemize}
