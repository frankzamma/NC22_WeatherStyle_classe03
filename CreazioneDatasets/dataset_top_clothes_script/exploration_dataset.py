...
# costruisce un grafico a barre dove mostra come varia il punteggio rispetto al materiale
sns.barplot(data=df, x="Materiale", y="Punteggio")
# plt.show()

# mostra dei grafici a barre dove mostra come varia il punteggio rispetto a ogni feature
...
# mostra la forma della distribuzione delle variabili come sopra ma in modo più formale
...
# mostra i grafici creati precedentemente, attenzione a quelli creati nel for
plt.show()
